    ...
    private fun setUserProperties() {
        ...
        firebaseAnalytics.setUserProperty(
            ...
            when (displayModeHelper.getDisplayMode()) {
                resHelper.getString(R.string.dark_value) -> UserProperty.DARK.propertyName
                resHelper.getString(R.string.light_value) -> UserProperty.LIGHT.propertyName
        ...
        Weather.getPreferredUnit(
            ...
            firebaseAnalytics.setUserProperty(
                ...
                if (it == resHelper.getString(R.string.temperature_celsius)) {
        ...
        Weather.getPreferredUnit(
            ...
            firebaseAnalytics.setUserProperty(
                ...
                when (it) {
                    resHelper.getString(R.string.wind_speed_ms) -> UserProperty.MPS.propertyName
                    resHelper.getString(R.string.wind_speed_mph) -> UserProperty.MPH.propertyName
                    resHelper.getString(R.string.wind_speed_kmh) -> UserProperty.KMPH.propertyName
                    resHelper.getString(R.string.wind_speed_knots) -> UserProperty.KN.propertyName
        ...
        Weather.getPreferredUnit(
            resHelper.getString(CacheService.KEY_WIND_DIR),
            resHelper.getString(R.string.wind_direction_cardinal)
        ).let {
            firebaseAnalytics.setUserProperty(
                UserProperty.UNIT_WIND_DIRECTION.propertyName,
                if (it == resHelper.getString(R.string.wind_direction_cardinal)) {
        ...
        Weather.getPreferredUnit(
            resHelper.getString(CacheService.KEY_PRECIP),
            resHelper.getString(R.string.precipitation_mm)
        ).let {
            firebaseAnalytics.setUserProperty(
                UserProperty.UNIT_PRECIPITATION.propertyName,
                if (it == resHelper.getString(R.string.precipitation_mm)) {
        ...
        Weather.getPreferredUnit(
            resHelper.getString(CacheService.KEY_PRESSURE),
            resHelper.getString(R.string.pressure_hpa)
        ).let {
            firebaseAnalytics.setUserProperty(
                UserProperty.UNIT_PRESSURE.propertyName,
                if (it == resHelper.getString(R.string.pressure_hpa)) {
