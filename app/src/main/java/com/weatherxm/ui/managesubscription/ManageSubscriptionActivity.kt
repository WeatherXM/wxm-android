...
class ManageSubscriptionActivity : BaseActivity() {
    ...
    @Preview
    @Composable
    fun PremiumFeatures(onGetPremium: () -> Unit = {}) {
        Column(
            verticalArrangement = spacedBy(dimensionResource(R.dimen.margin_normal))
        ) {
            LargeText(
                text = getString(R.string.premium_features),
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            LargeText(
                                text = getString(R.string.mosaic_forecast),
                                fontWeight = FontWeight.Bold,
                                fontSize = 18.sp
                            )
                            MediumText(
                                text = getString(R.string.mosaic_forecast_explanation),
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            LargeText(
                                text = getString(R.string.hourly_forecast),
                                fontWeight = FontWeight.Bold,
                                fontSize = 18.sp
                            )
                            MediumText(
                                text = getString(R.string.just_the_basics),
                                colorRes = R.color.darkGrey
                            )
                        }
                    }
