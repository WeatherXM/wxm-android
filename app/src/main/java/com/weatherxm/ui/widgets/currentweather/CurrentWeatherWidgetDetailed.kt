...
class CurrentWeatherWidgetDetailed : AppWidgetProvider(), KoinComponent {
    ...
    private fun updateWidget(
        ...
        val remoteViews = RemoteViews(context.packageName, R.layout.widget_current_weather_detailed)
        ...
        if (shouldLogin == true) {
            ...
            remoteViews.onDevice(
                context, widgetManager, appWidgetId, device, WidgetType.CURRENT_WEATHER_DETAILED
            )
        }
    }
    ...
    private fun updateAllWidgets(
        ...
        if (shouldLogin == true) {
            widgetsToUpdate.forEach {
                RemoteViews(context.packageName, R.layout.widget_current_weather_detailed)
