...
class DfuService : DfuBaseService() {
    ...
    override fun getNotificationTarget(): Class<out Activity> {
         ...
         * closed. The system will restore the previous activity. However, if the application has
         * been closed during upload and you click the notification, a NotificationActivity will
